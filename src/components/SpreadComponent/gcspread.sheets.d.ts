declare module GcSpread.Sheets{
    export class StyleHelper {
        constructor();
        static _scaleFont(font, factor, minFont?, ignoreCache?): any;
    }
    ...
    export class FocusHelper{
      static setActiveElement(sheet: any);
    }
    ...
    export class Sheet{
        _doPaste(pasteData?, callback?);
        _doCut(arg0: boolean): string;
